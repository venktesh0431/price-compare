                ...
                <div className="container py-5">
                    ...
                    <nav aria-label="breadcrumb animated slideInDown">
                        <ol className="breadcrumb text-uppercase mb-0">
                            ...
                            <li className="breadcrumb-item text-primary active" aria-current="page"><Link className="text-white" to="/about">About</Link></li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div className="row g-4">
                                <div className="col-12">
                                    <div className="d-flex align-items-start">
                                        <img className="flex-shrink-0" src="assets/img/icons/icon-2.png" alt="Icon"/>
                                        <div className="ms-4">
                                ...
                                <div className="col-12">
                                    <div className="d-flex align-items-start">
                                        <img className="flex-shrink-0" src="assets/img/icons/icon-3.png" alt="Icon"/>
                                        <div className="ms-4">
                                ...
                                <div className="col-12">
                                    <div className="d-flex align-items-start">
                                        <img className="flex-shrink-0" src="assets/img/icons/icon-4.png" alt="Icon"/>
                                        <div className="ms-4">
